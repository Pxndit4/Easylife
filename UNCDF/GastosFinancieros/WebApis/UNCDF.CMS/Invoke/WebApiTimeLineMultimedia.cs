...
namespace UNCDF.CMS
{
    public class WebApiTimeLineMultimedia
    {
        ...
        public string UpdateTimeLineMultimedia(MTimeLineMultimedia MTimeLineMultimedia, Session objSession)
        {
            ...
            string bodyrequest = JsonConvert.SerializeObject(request);
            string statuscode = string.Empty;
            string bodyresponse = new Helper().InvokeApi("Project/api/TimeLineMultimedia", "UpdateTimeLineMultimedia", bodyrequest, ref statuscode);
        ...
        public string DeleteTimeLineMultimedia(MTimeLineMultimedia MTimeLineMultimedia, Session Session)
        {
            ...
            string bodyrequest = JsonConvert.SerializeObject(request);
            string statuscode = string.Empty;
            string bodyresponse = new Helper().InvokeApi("Project/api/TimeLineMultimedia", "DeleteTimeLineMultimedia", bodyrequest, ref statuscode);
