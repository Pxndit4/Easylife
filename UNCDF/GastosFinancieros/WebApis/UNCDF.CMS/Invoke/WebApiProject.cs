...
namespace UNCDF.CMS
{
    public class WebApiProject
    {
        ...
        public List<MProject> GetProjectsCodeExclusions(MProject eProject)
        {
            List<MProject> projects = new List<MProject>();
            ProjectsRequest request = new ProjectsRequest();
            ProjectsResponse response = new ProjectsResponse();
            ...
            string bodyrequest = JsonConvert.SerializeObject(request);
            string statuscode = string.Empty;
            string bodyresponse = new Helper().InvokeApi("Project/api/project", "GetProjectsCodeExclusions", bodyrequest, ref statuscode);
