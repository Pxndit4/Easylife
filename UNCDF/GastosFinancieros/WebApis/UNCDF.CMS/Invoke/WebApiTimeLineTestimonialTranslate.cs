...
namespace UNCDF.CMS
{
    public class WebApiTimeLineTestimonialTranslate
    {
        ...
        public string UpdateTimeLineTestimonialTranslate(MTimeLineTestimonialTranslate MTimeLineTestimonialTranslate, Session Session)
        {
            ...
            string bodyrequest = JsonConvert.SerializeObject(request);
            string statuscode = string.Empty;
            string bodyresponse = new Helper().InvokeApi("Project/api/TimeLineTestimonialTranslate", "UpdateTimeLineTestimonialTranslate", bodyrequest, ref statuscode);
        ...
        public string DeleteTimeLineTestimonialTranslate(MTimeLineTestimonialTranslate MTimeLineTestimonialTranslate, Session Session)
        {
            ...
            string bodyrequest = JsonConvert.SerializeObject(request);
            string statuscode = string.Empty;
            string bodyresponse = new Helper().InvokeApi("Project/api/TimeLineTestimonialTranslate", "DeleteTimeLineTestimonialTranslate", bodyrequest, ref statuscode);
