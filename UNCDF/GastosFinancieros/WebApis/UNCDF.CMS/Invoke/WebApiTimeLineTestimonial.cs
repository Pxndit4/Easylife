...
namespace UNCDF.CMS
{
    public class WebApiTimeLineTestimonial
    {
        ...
        public string UpdateTimeLineTestimonial(MTimeLineTestimonial MTimeLineTestimonial, Session Session)
        {
            ...
            string bodyrequest = JsonConvert.SerializeObject(request);
            string statuscode = string.Empty;
            string bodyresponse = new Helper().InvokeApi("Project/api/TimeLineTestimonial", "UpdateTimeLineTestimonial", bodyrequest, ref statuscode);
        ...
        public string DeleteTimeLineTestimonial(MTimeLineTestimonial MTimeLineTestimonial, Session Session)
        {
            ...
            string bodyrequest = JsonConvert.SerializeObject(request);
            string statuscode = string.Empty;
            string bodyresponse = new Helper().InvokeApi("Project/api/TimeLineTestimonial", "DeleteTimeLineTestimonial", bodyrequest, ref statuscode);
